...
@implementation DJWMasterViewController
...
- (void)loadJobs
{
    [[RKObjectManager sharedManager] getObjectsAtPath:@"/jobs" parameters:nil success:^(RKObjectRequestOperation *operation, RKMappingResult *mappingResult) {
